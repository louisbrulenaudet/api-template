...
- Do not suppress diagnostics to clear the gate: no `# noqa`, blanket ignore, `Any` / `type: ignore`. Fix the cause or report failures (see `.cursor/rules/core/guardrails.mdc`).
