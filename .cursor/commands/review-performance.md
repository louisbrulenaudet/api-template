---
description: Performance review - blocking I/O on async paths, hot-path complexity, validation cost, cache keys and TTL, outbound client reuse and timeouts, middleware overhead. Outputs a plan only.
