---
description: Configuration review - env and secrets handling, Settings contract, Docker/Compose parity, frozen installs, version pins with multiple homes. Outputs a plan only.
